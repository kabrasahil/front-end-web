...
const Footer = () => {
  return (
    <footer className="bg-stone-900">
      <div className="mx-auto p-4 sm:p-6 w-full flex flex-1 justify-evenly flex-wrap container md:justify-evenly">
        ...
        <div className="mb-5">
          <a href="" className="flex items-center mb-5">
            ...
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-zinc-300">
              The Indian Game Theory Society
            </span>
          </a>
          <span className="text-base text-zinc-200 sm:text-left dark:text-zinc-400 font-semibold">
            © 2023{" "}
