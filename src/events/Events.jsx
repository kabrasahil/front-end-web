...
export default function Events() {
    return (
        ...
        <div className="flex justify-center">
                <p className='absolute top-[8.5rem] lg:top-[5rem] mx-auto !leading-normal font-extrabold text-5xl lg:text-9xl text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-pink-500'>Events</p>
                <p className='absolute top-[12rem] lg:top-[14rem] text-slate-300 text-md lg:text-xl mx-auto'>Where boredom ends.</p>
            </div>
            {/* <img src={ufo} className="object-cover w-[100vw] z-10" /> */}
            <section className="mt-[15rem] w-full flex justify-center">
                <EventsTab />
            </section>
