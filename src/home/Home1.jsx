...
export default function Home1() {
    return(
        <div className='flex justify-center gap-10 items-center overflow-x-hidden h-screen bg-stone-900'>
            <div className='flex flex-col gap-5 w-96'>
                <h3 className='text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-indigo-500'>About</h3>
                ...
                <button className='bg-gradient-to-r from-indigo-500 to-blue-400 text-white font-medium text-lg w-44 rounded-full h-10'>Learn more</button>
            </div>
