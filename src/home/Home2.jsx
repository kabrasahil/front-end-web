  ...
  return (
    <div className="flex justify-center gap-16 px-8 items-center overflow-x-hidden bg-stone-900 py-12">
      ...
      <div className="flex flex-col gap-5 w-96">
        <h3 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-pink-300">
          About
        </h3>
        ...
        <button className="flex justify-center bg-gradient-to-r from-pink-700 to-pink-900 text-white font-medium text-lg w-44 rounded-full h-10">
          Learn more
        </button>
      </div>
